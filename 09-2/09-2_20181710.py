...
from keypad2 import numPadList, operatorList, constantList, constantDic, functionList, functionMap
...
class Calculator(QWidget):
    ...
    def buttonClicked(self):
        ...
        if key == '=':
            ...
            # 만약 (3pi)를 누르면 (3*pi)값이 나오도록 변경
            value = self.display.text() + '*' + constantDic[i][1]
